    ...
    <footer className="relative mt-10">
      <div className="w-full pt-12">
        <div className="relative w-full overflow-hidden border-t border-[var(--border-strong)] bg-[var(--footer-bg)] shadow-[var(--shadow-card)]">
          <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(145deg,rgba(255,255,255,0.18),transparent_42%),radial-gradient(circle_at_top_right,var(--accent-soft),transparent_30%)]" />
          ...
          <div className="relative mx-auto grid w-full max-w-[92rem] gap-6 lg:grid-cols-[1.2fr_0.9fr_0.9fr]">
            <div className="px-4 py-6 sm:px-6 sm:py-7 lg:px-10">
              <div className="flex items-center gap-4">
                <div className="rounded-[var(--radius-sm)] border border-[var(--border-strong)] bg-white/30 px-3.5 py-2.5 shadow-[var(--shadow-soft)]">
                  <Image
                    src="/ngonda-logo.png"
                    alt="NGONDA e.V."
                    width={970}
              ...
              <div className="mt-6 grid gap-3 text-sm">
                <div className="flex items-start gap-3 rounded-[var(--radius-md)] border border-[var(--border)] bg-white/18 px-4 py-3">
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  <div className="rounded-[var(--radius-md)] border border-[var(--border)] bg-white/18 px-4 py-3 text-[var(--text)]">
            ...
            <div className="border-t border-[var(--border-strong)] px-4 py-6 sm:px-6 sm:py-7 lg:border-l lg:border-t-0 lg:px-7">
              ...
              <ul className="mt-5 grid gap-2 text-sm">
                {SECONDARY_LINKS.map((item) => (
                  <li key={item.href}>
                    <Link
                      href={item.href}
                      className="flex items-center justify-between rounded-[var(--radius-sm)] border border-transparent px-3 py-2 text-[var(--text)] transition-colors hover:border-[var(--border)] hover:bg-white/18 hover:text-[var(--accent)]"
                    >
            ...
            <div className="border-t border-[var(--border-strong)] px-4 py-6 sm:px-6 sm:py-7 lg:border-l lg:border-t-0 lg:px-7">
              ...
              <div className="mt-4 rounded-[var(--radius-md)] border border-[var(--border)] bg-white/18 p-4 text-xs leading-6 text-[var(--muted)]">
          ...
          <div className="relative border-t border-[var(--border-strong)]">
            <div className="mx-auto flex w-full max-w-[92rem] flex-col gap-4 px-4 pb-4 pt-4 sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-10">
                ...
                {socialLinks.map((item) => {
                  ...
                  return (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex items-center gap-2 rounded-full border border-[var(--border-strong)] bg-white/12 px-3 py-2 text-xs font-semibold uppercase tracking-[0.18em] text-[var(--muted)] transition-colors hover:bg-[var(--accent-soft)] hover:text-[var(--text)]"
                    >
